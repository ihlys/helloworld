...
public class HelloWorldProviderImpl implements HelloWorldProvider {
	 ...
	 * 
	 * @param resourceBundle bundle for loading resources.
	 */
	 ...
	 * 
	 * @param helloWorldProvider provider that provides messages content.
	 */
	 ...
	 * 
	 * @param currentTime an instance of {@link java.util.Calendar} that represents current time.
	 * @return content for message.
	 * @throws IllegalArgumentException if the specified currentTime is null.
	 */
